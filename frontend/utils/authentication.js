const APP_USER_STORAGE = 'BEACH-RESORT-FRONTEND-USER-STORAGE';
const APP_ACCESS_TOKEN = 'BEACH-RESORT-FRONTEND-ACCESS-TOKEN';
const APP_REFRESH_TOKEN = 'BEACH-RESORT-FRONTEND-REFRESH-TOKEN';
