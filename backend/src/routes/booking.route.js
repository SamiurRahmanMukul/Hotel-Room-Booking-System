...
const { placedBookingOrder } = require('../controllers/booking.controllers');
...
// router.route('/get-booking-orders/:id').get(isAuthenticatedUser, isBlocked, getBookingOrderByUserId);
...
// router.route('/get-booking-orders').get(isAuthenticatedUser, isBlocked, isAdmin, getBookingOrderForAdmin);
